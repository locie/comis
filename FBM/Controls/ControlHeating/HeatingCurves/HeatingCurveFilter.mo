within FBM.Controls.ControlHeating.HeatingCurves;
...
equation
  ...
  qRel = max(0, (TRoo_in_internal - TOutOffSet)*Buildings.Utilities.Math.Functions.inverseXRegularized(TRoo_nominal -TOutOffSet_nominal, 0.01));
...
<p><ul>
<li>2016 November, Wilfried Thomaré : Redesigned for the Buildings library</li>
