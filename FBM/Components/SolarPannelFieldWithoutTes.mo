...
model SolarPannelFieldWithoutTes
  ...
  Controls.ControlSolar.CTRL_Solar_SecPump cTRL_Solar_SecPump
    annotation (Placement(transformation(extent={{30,6},{46,22}})));
...
equation
 ...
 if includePipesSol then
  ...
  connect(pumpSupply.Tret, cTRL_Solar_SecPump.THotSol) annotation (Line(points={{7.6,
          44.4},{7.6,48},{14,48},{14,14},{29.2,14}},                 color={0,0,
          127}));
  ...
  connect(cTRL_Solar_SecPump.TBoTank, TBoTank) annotation (Line(points={{29.52,
          7.6},{29.52,10},{22,10},{22,-68},{102,-68}}, color={0,0,127}));
  connect(T, pumpSupply.Tret) annotation (Line(points={{-108,-60},{14,-60},{14,
          44.4},{7.6,44.4}}, color={0,0,127}));
  connect(cTRL_Solar_Prim.y1, cTRL_Solar_SecPump.P0) annotation (Line(points={{-59,18},
          {-14,18},{-14,19.28},{29.2,19.28}},     color={255,0,255}));
  connect(cTRL_Solar_Prim.y, pumpSupply.u)
    annotation (Line(points={{-59,22},{0,22},{0,23.2}}, color={0,0,127}));
  connect(cTRL_Solar_SecPump.y, pumpSupply1.u) annotation (Line(points={{46.8,14},
          {64.35,14},{64.35,24.24},{63.5,24.24}},     color={0,0,127}));
