    ...
    if linearized then
      ...
      if homotopyInitialization then
        if from_dp then
          ...
          dp=homotopy(actual=Buildings.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(m_flow=m_flow/nParCir, k=k,
        ...
        if from_dp then
          ...
          dp=Buildings.Fluid.BaseClasses.FlowModels.basicFlowFunction_m_flow(m_flow=m_flow/nParCir, k=k,
                                   m_flow_turbulent=m_flow_turbulent/nParCir);
        end if;  // from_dp
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://FBM/images/Component/FixedResistances/FixedResistanceDpM.png\"/>
</p>
<p>
If the parameter
