...
public
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort THot(
 ...
 Buildings.Fluid.Movers.BaseClasses.IdealSource idealSource(
  ...
  Buildings.Fluid.FixedResistances.Pipe pipe_HeatPort(
    redeclare package Medium = Medium,
    allowFlowReversal=false,
    m_flow_nominal=m_flow_nominal,
  ...
  Buildings.Utilities.Math.SmoothMax deltaT_with_smoothmax(deltaX=0.1)
  ...
  Buildings.Utilities.Math.SmoothMin mFloHot(deltaX=1e-3*m_flow_nominal)
