...
package MediumA = Buildings.Media.Air
  ...
  Modelica.Blocks.Sources.Pulse mDHW60C(
    ...
    width=4)        annotation (Placement(transformation(extent={{-10,-10},
        ...
        rotation=90,
        origin={142,-58})));
  FBM.AHUSystems.CTA_VAVReheat_Elec cTA_VAVReheat(
    VRoom={7*7*3,7*7*3},
    nReheat=nZones,
    m_flow_nominal=0.75,
    ...
    annotation (Placement(transformation(extent={{148,98},{88,136}})));
...
equation
  ...
  connect(roo.heaPorAir, TRoo[1].port) annotation (Line(points={{-17,90},{50,90},
          {50,66},{64,66},{64,65}},
                            color={191,0,0}));
  connect(roo1.heaPorAir, TRoo[2].port) annotation (Line(points={{-17,40},{-17,
          40},{50,40},{50,66},{64,66},{64,65}},
                            color={191,0,0}));
  ...
  connect(TRoo.T, cTA_VAVReheat.TRoo) annotation (Line(points={{74,65},{84,65},
          {84,136.224},{102.483,136.224}},
                                  color={0,0,127}));
  connect(cTA_VAVReheat.port_a2[1], roo.ports[1]) annotation (Line(points={{88,
          102.471},{-46,102.471},{-46,78},{-31,78}},
                                      color={0,127,255}));
  connect(cTA_VAVReheat.port_b1[1], roo.ports[2]) annotation (Line(points={{88,
          125.941},{-46,125.941},{-46,82},{-31,82}},
                                      color={0,127,255}));
  connect(cTA_VAVReheat.port_a2[2], roo1.ports[1]) annotation (Line(points={{88,
          102.471},{-46,102.471},{-46,28},{-31,28}},
                                      color={0,127,255}));
  connect(cTA_VAVReheat.port_b1[2], roo1.ports[2]) annotation (Line(points={{88,
          125.941},{-46,125.941},{-46,32},{-31,32}},
                                      color={0,127,255}));
  connect(cTA_VAVReheat.weaBus, weaBus) annotation (Line(
      points={{144.276,132.424},{20.6,132.424},{20.6,120},{-64,120}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(heating.port_b, cTA_VAVReheat.port_b) annotation (Line(points={{152.2,
          40},{152,40},{152,72},{120,72},{120,102},{120,111.412},{119.034,
          111.412}},
        color={0,127,255}));
  connect(cTA_VAVReheat.port_a, heating.port_a) annotation (Line(points={{139.724,
          111.412},{139.724,75.706},{155.2,75.706},{155.2,40}},         color={
          0,127,255}));
