...
package MediumA = Buildings.Media.Air
  ...
  FBM.HeatingDHWsystems.SimpleHeatingSystem.Boiler_Radiator
    heating(
...
equation
  ...
  connect(heating.mDHW60C, mFlowDH.y) annotation (Line(points={{148.5,21.82},{150,
          21.82},{150,1}},               color={0,0,127}));
  ...
  connect(cTA_VAVReheat.port_b, heating.port_b) annotation (Line(points={{104.138,
          ...
          134.235},{-46,134.235},{-46,77},{-31,77}},
                                      color={0,127,255}));
  connect(cTA_VAVReheat.port_b1[1], roo.ports[2]) annotation (Line(points={{10,
          198.471},{-46,198.471},{-46,79},{-31,79}},
                                      color={0,127,255}));
  connect(cTA_VAVReheat.port_a2[2], roo1.ports[1]) annotation (Line(points={{10,
          134.235},{-46,134.235},{-46,27},{-31,27}},
                                      color={0,127,255}));
  connect(cTA_VAVReheat.port_b1[2], roo1.ports[2]) annotation (Line(points={{10,
          198.471},{-46,198.471},{-46,29},{-31,29}},
                                      color={0,127,255}));
