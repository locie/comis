...
package AHUSystems "Collection of systems dedicated to ventilation service"
  model CTA_VAVReheat_Elec "VAV Reheat AHU with electric VAV heater"
    ...
    Buildings.Controls.Continuous.LimPID conHeater(
      controllerType=Modelica.Blocks.Types.SimpleController.PI,
      k=0.01,
      Ti=600,
      yMax=1,
      yMin=0) annotation (Placement(transformation(extent={{-22,-64},{-2,-44}})));
  equation
    ...
    connect(conPum.y, pumHotDeck.y) annotation (Line(
        ...
        color={0,0,127},
        pattern=LinePattern.Dash));
    connect(conHeater.y, valHea.y) annotation (Line(
        points={{-1,-54},{16,-54},{128,-54}},
        color={0,0,127},
        pattern=LinePattern.Dash));
    connect(TSupSetHea.y, conHeater.u_s) annotation (Line(
        points={{-151,130},{-36,130},{-36,-54},{-24,-54}},
        color={0,0,127},
        pattern=LinePattern.Dash));
    connect(conHeater.u_m, TCoiHeaOut.T) annotation (Line(
        points={{-12,-66},{-12,-78},{20,-78},{20,-19},{72,-19},{154,-19}},
        color={0,0,127},
        pattern=LinePattern.Dash));
...
<ul>
<li> December 2016, by Wilfried Thomaré:<br/>
Import in the FBM librairy, set the modularized part available (the number of VAVBranch) and offers an electric and hydraulic reheater
</li>
<li>
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/426\">issue 426</a>.
  ...
  model DoubleFlux_FreeCooling_MechanicalCooling
    ...
    Buildings.Fluid.HeatExchangers.PrescribedOutlet coo(
      ...
      energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
      QMax_flow=0,
      m_flow_nominal=VBuilding*1.225*Tau/3600) "Coil for mechanical cooling"
...
<ul>
<li> January 2017, by Wilfried Thomaré:<br/>
Import in the FBM librairy, set the modularized part available.
</li>
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/426\">issue 426</a>.
  ...
  model AHU_ActiveBeams_HeatingCooling
    "AHU with hot and cold battery and active beams as terminal"
     extends Buildings.Fluid.Interfaces.PartialTwoPortInterface(redeclare
        replaceable package Medium =
          Buildings.Media.Water);
     extends FBM.AHUSystems.BaseClasses.VAVReheatParameter;
    ...
    Buildings.Fluid.FixedResistances.PressureDrop dpSupDuc(
      ...
      dp_nominal=20,
      m_flow_nominal=m_flow_nominal_Air) "Pressure drop for supply duct"
      annotation (Placement(transformation(extent={{318,-20},{338,0}})));
    Buildings.Fluid.FixedResistances.PressureDrop dpRetDuc(
      redeclare package Medium = MediumA,
      dp_nominal=20,
      m_flow_nominal=m_flow_nominal_Air) "Pressure drop for return duct"
    ...
    Buildings.Fluid.Sensors.VolumeFlowRate senSupFlo(redeclare package Medium =
          MediumA, m_flow_nominal=m_flow_nominal_Air)
      "Sensor for supply fan flow rate"
      annotation (Placement(transformation(extent={{256,-20},{276,0}})));
    Buildings.Controls.SetPoints.OccupancySchedule occSch(occupancy=3600*{OccOn,
          OccOff})
      "Occupancy schedule"
      annotation (Placement(transformation(extent={{346,152},{326,172}})));
    ...
    Buildings.Examples.VAVReheat.Controls.DuctStaticPressureSetpoint
      ...
      controllerType=Modelica.Blocks.Types.SimpleController.P)
               "Duct static pressure setpoint"
      annotation (Placement(transformation(extent={{128,24},{148,44}})));
    FBM.Components.ActiveBeams.CoolingAndHeating[nReheat] ActiveBeams(
      redeclare package MediumA = MediumA,
      redeclare package MediumW = MediumW,
      VRoo={VRoom[i] for i in 1:nReheat},
      m_flow_nominal={m_flow_room[i] for i in 1:nReheat}) "Zone of building"
      annotation (Placement(transformation(extent={{384,12},{316,80}})));
    Buildings.Examples.VAVReheat.Controls.FanVFD
                    conFanRet(
                          xSet_nominal(displayUnit="m3/s") = m_flow_nominal_Air/1.2, r_N_min=
          r_N_min,
    ...
    Buildings.Fluid.HeatExchangers.WetCoilCounterFlow cooCoi(
      ...
      annotation (Placement(transformation(extent={{182,-6},{162,-26}})));
  ...
  equation
    ...
    connect(TSupSetHea.y,heaCoiCon. u_s) annotation (Line(
        ...
        pattern=LinePattern.Dash));
    connect(fanRet.port_a,dpRetFan. port_b) annotation (Line(
        points={{184,130},{220,130},{220,28}},
        color={0,0,0},
        smooth=Smooth.None,
        pattern=LinePattern.Dot));
    connect(fanSup.port_b,dpRetFan. port_a) annotation (Line(
        points={{210,-10},{210,-2},{220,-2},{220,8}},
        color={0,0,0},
        smooth=Smooth.None,
        pattern=LinePattern.Dot));
    connect(senSupFlo.port_b,dpSupDuc. port_a) annotation (Line(
        points={{276,-10},{318,-10}},
        color={0,127,255},
        smooth=Smooth.None,
        thickness=0.5));
    connect(controlBus,modeSelector. cb) annotation (Line(
    ...
    connect(occSch.occupied,controlBus. occupied) annotation (Line(
        ...
        extent={{6,3},{6,3}}));
    connect(controlBus,conFanSup. controlBus) annotation (Line(
        points={{300,194},{156,194},{156,42},{169,42}},
        color={255,204,51},
        thickness=0.5,
        smooth=Smooth.None), Text(
        string="%first",
    ...
    connect(fil.port_a,TMix. port_b) annotation (Line(
        ...
        thickness=0.5));
    connect(conFanSup.y,fanSup. y) annotation (Line(
        points={{187,34},{199.8,34},{199.8,2}},
        color={0,0,127},
        smooth=Smooth.None,
        pattern=LinePattern.Dash));
    connect(TCoiHeaOut.T,heaCoiCon. u_m) annotation (Line(
        points={{144,1},{144,14},{64,14},{64,-40},{-12,-40}},
        color={0,0,127},
        pattern=LinePattern.Dash));
    connect(heaCoiCon.y,valHea. y) annotation (Line(
        points={{-1,-28},{16,-28},{16,-34},{128,-34}},
    ...
    connect(eco.port_Sup,TMix. port_a) annotation (Line(
        ...
        thickness=0.5));
    connect(pSetDuc.y,conFanSup. u) annotation (Line(
        points={{149,34},{164,34}},
        color={0,0,127},
        smooth=Smooth.None,
        pattern=LinePattern.Dash));
    connect(heaCoi.port_b1,TCoiHeaOut. port_a) annotation (Line(
        points={{128,-10},{134,-10}},
        color={0,127,255},
        smooth=Smooth.None,
        thickness=0.5));
    connect(controlBus,conFanRet. controlBus) annotation (Line(
        ...
        extent={{-6,3},{-6,3}}));
    connect(senSupFlo.V_flow,conFanRet. u) annotation (Line(
        points={{266,1},{266,86},{110,86},{110,160},{122,160}},
        color={0,0,127},
        smooth=Smooth.None,
        pattern=LinePattern.Dash));
    connect(senRetFlo.port_b,fanRet. port_a) annotation (Line(
    ...
    connect(min.y, controlBus.TRooMin) annotation (Line(
        ...
        extent={{6,3},{6,3}}));
    connect(pumHotDeck.port_b, dpSen.port_a) annotation (Line(
        points={{-118,-76},{-116,-76},{-116,-92},{-118,-92}},
        color={0,127,255},
        smooth=Smooth.None));
    connect(dpSen.port_b, pumHotDeck.port_a) annotation (Line(
        points={{-138,-92},{-140,-92},{-140,-76},{-138,-76}},
        color={0,127,255},
        smooth=Smooth.None));
    connect(gain.u,dpSen. p_rel) annotation (Line(
        points={{-110,-108},{-128,-108},{-128,-101}},
        color={0,0,127},
        pattern=LinePattern.Dash));
    connect(pumHotDeck.port_a, port_a) annotation (Line(points={{-138,-76},{-152,-76},
            {-152,0},{-100,0}},      color={0,127,255}));
    connect(gain.y, conPum.u_m) annotation (Line(
        points={{-87,-108},{-87,-108},{-88,-108},{-68,-108},{-66,-108},{-66,-106}},
        color={0,0,127},
        pattern=LinePattern.Dash));
    connect(hysPum.y,swiPum. u2) annotation (Line(
        points={{13,-82},{-10,-82},{-10,-94},{-22,-94}},
        color={255,0,255},
        pattern=LinePattern.Dash));
    connect(pumHotDeckOn.y, swiPum.u1) annotation (Line(
        points={{-11,-70},{-16,-70},{-18,-70},{-18,-86},{-22,-86}},
        color={0,0,127},
        pattern=LinePattern.Dash));
    connect(pumHotDeckOff.y, swiPum.u3) annotation (Line(
        points={{-11,-102},{-18,-102},{-22,-102}},
        color={0,0,127},
        pattern=LinePattern.Dash));
    connect(conPum.u_s, swiPum.y) annotation (Line(
        points={{-54,-94},{-45,-94}},
        ...
        pattern=LinePattern.Dash));
    connect(valHea.y_actual, hysPum.u) annotation (Line(
        points={{133,-29},{70.5,-29},{70.5,-82},{36,-82}},
        color={0,0,127},
        pattern=LinePattern.Dash));
    connect(conPum.y, pumHotDeck.y) annotation (Line(
        points={{-77,-94},{-90,-94},{-90,-64},{-128.2,-64}},
        color={0,0,127},
        pattern=LinePattern.Dash));
    connect(heaCoi.port_b2, port_b)
      annotation (Line(points={{108,-22},{100,-22},{100,0}}, color={0,127,255}));
    connect(pumHotDeck.port_b, jun.port_1)
      annotation (Line(points={{-118,-76},{-72,-76}},
                                                    color={0,127,255}));
    connect(valHea.port_a, jun.port_3)
      annotation (Line(points={{140,-44},{140,-50},{140,-66},{-62,-66}},
                                                     color={0,127,255}));
    connect(valCoo.port_b,cooCoi. port_a1) annotation (Line(
        points={{188,-34},{188,-22},{182,-22}},
        color={0,127,0},
        smooth=Smooth.None,
        thickness=0.5));
    connect(TCoiHeaOut.port_b, cooCoi.port_a2)
      annotation (Line(points={{154,-10},{162,-10}}, color={0,127,255}));
    connect(cooCoi.port_b2, fanSup.port_a)
      annotation (Line(points={{182,-10},{190,-10}}, color={0,127,255}));
    connect(cooCoiCon.y, valCoo.y) annotation (Line(points={{149,-94},{174,-94},
            {174,-44},{176,-44}},
                             color={0,0,127},
        pattern=LinePattern.Dash));
    connect(fanSup.port_b, TSup.port_a) annotation (Line(points={{210,-10},{210,
            -10},{220,-10}},
                        color={0,127,255}));
    connect(TSup.port_b, senSupFlo.port_a) annotation (Line(points={{240,-10},{
            240,-10},{256,-10}},
                             color={0,127,255}));
    connect(TSup.T, cooCoiCon.u_m) annotation (Line(points={{230,-21},{230,-21},
            {230,-106},{138,-106}},
                               color={0,0,127},
        pattern=LinePattern.Dash));
    connect(TSetCoo.TSet, cooCoiCon.u_s) annotation (Line(
        points={{-111,148},{63.5,148},{63.5,-94},{126,-94}},
        color={0,0,127},
        pattern=LinePattern.Dash));
    connect(jun.port_2, ActiveBeams[1].watHea_a) annotation (Line(points={{-52,
            -76},{312,-76},{312,46},{384,46}}, color={0,127,255}));
    connect(ActiveBeams[1].watHea_b, port_b) annotation (Line(points={{316,46},
            {390,46},{390,0},{100,0}}, color={0,127,255}));
    connect(dpSupDuc.port_b, ActiveBeams[1].air_a) annotation (Line(points={{
            338,-10},{386,-10},{386,29},{316,29}}, color={0,127,255}));
   annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-180,
              -120},{400,220}}),
                           graphics={
          Rectangle(
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/426\">issue 426</a>.
  ...
  end AHU_ActiveBeams_HeatingCooling;
end AHUSystems;
